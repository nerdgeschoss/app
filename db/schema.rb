...
ActiveRecord::Schema[8.1].define(version: 2026_09_19_101051) do
  ...
  create_table "job_applications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.enum "level", null: false, enum_type: "job_level"
    t.text "motivation", null: false
    t.enum "offered_level", enum_type: "job_level"
    t.enum "status", default: "review", null: false, enum_type: "job_application_status"
    t.string "token", null: false
    t.datetime "updated_at", null: false
    t.uuid "user_id"
    t.string "website_url"
    t.index ["email"], name: "index_job_applications_on_email"
    t.index ["token"], name: "index_job_applications_on_token", unique: true
  ...
  create_table "yael_events", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "name", null: false
