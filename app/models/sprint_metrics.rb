...
class SprintMetrics
  METRICS = [:billable_per_day, :daily_nerd_percentage, :tracked_per_day, :billable_hours, :billable_hours_percentage, :retro_rating, :finished_storypoints, :turnover_per_storypoint, :turnover_per_storypoint_against_avarage].freeze
